...
cone_light_network_packet_t cone_light_packet_set_color(uint8_t red, uint8_t green, uint8_t blue, uint8_t brightness, uint8_t node_or_group_id);
...
cone_light_network_packet_t cone_light_packet_set_brightness(uint8_t brightness, uint8_t node_or_group_id);
